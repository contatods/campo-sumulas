#!/usr/bin/env python3
"""
sumula_app.py — Gerador de Súmulas CAMPO v7  (Interface v2.0)
...
print("╔══════════════════════════════════════════════╗")
print("║  CAMPO v7 — Gerador de Súmulas  (v2.0)       ║")
print("╚══════════════════════════════════════════════╝\n")
...
<title>Gerador de Súmulas — CAMPO v7</title>
<style>
...
.hdr-right{margin-left:auto;font-size:10px;color:var(--text4);letter-spacing:.05em}
...
<!-- ══ Header ═══════════════════════════════════════════════════════════════ -->
<header class="hdr">
  <span class="hdr-logo">CAMPO v7</span>
  <div class="hdr-divider"></div>
  <span class="hdr-title">Gerador de Súmulas</span>
  <span class="hdr-right">Digital Score</span>
</header>
...
def main():
    ...
    if IS_CLOUD:
        ...
        print("  CAMPO v7 online \u2014 pronto para receber conexoes\n")
    else:
